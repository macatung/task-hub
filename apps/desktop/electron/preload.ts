...
contextBridge.exposeInMainWorld('desktopApi', {
  ...
  agent: {
    ...
    startInteractive: (provider: string, cwd: string, prompt?: string, kind: 'task' | 'docs' = 'task', model?: string) => ipcRenderer.invoke('agent-start-interactive', safeClone({ provider, cwd, prompt, kind, model })),
