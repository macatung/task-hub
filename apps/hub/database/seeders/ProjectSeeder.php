    ...
    public function run(): void
    {
        $projects = [
            [
                ...
                'tech_stack' => ['Multi-Agent Framework', 'Google Gemini AI', 'OpenAI', 'Python / FastAPI', 'Laravel 12', 'Redis Queue', 'Qdrant Vector DB', 'Telegram & Zalo SDK'],
                'metrics' => [
                ...
                'midnight_fact' => 'Hệ thống tự động xử lý hơn 12,000 ca khiếu nại và tra cứu đơn hàng trong đêm Flash Sale mà không cần bất kỳ nhân sự CS nào trực ca.',
                'live_url' => null,
                'github_url' => null,
                'featured' => true,
                'order' => 1,
            ...
            [
                ...
                'tech_stack' => ['Laravel 12', 'Filament Admin 3', 'Livewire 3', 'React Native', 'MySQL', 'Google Gemini AI', 'Zoom API', 'SePay / VNPay IPN'],
                'metrics' => [
                ...
                'midnight_fact' => 'Tối ưu 50+ Artisan crawler tự động crawl và phân tích dữ liệu 1,500 mã cổ phiếu sàn HOSE/HNX lúc 2:00 AM mỗi ngày.',
                'live_url' => null,
                'github_url' => null,
                'featured' => true,
                'order' => 2,
            ...
            [
                ...
                'category' => 'tools',
                'cover_gradient' => 'from-cyan-950 via-blue-900 to-slate-950',
                'tags' => ['GIS / Spatial', 'QGIS Integration', 'PHP / Laravel', 'PostGIS', 'ReactJS'],
                'tech_stack' => ['PHP / Laravel', 'PostgreSQL / PostGIS', 'QGIS Spatial Engine', 'ReactJS', 'GeoJSON Map Engine', 'Docker'],
                'metrics' => [
                ...
                'midnight_fact' => 'Thuật toán tối ưu hóa tuyến cáp giúp tiết kiệm hàng trăm kilômét cáp quang trong dự án triển khai hạ tầng viễn thông.',
                'live_url' => null,
                'github_url' => null,
                'featured' => true,
                'order' => 3,
            ...
            [
                ...
                'tech_stack' => ['Node.js', 'Python (Machine Learning)', 'Elasticsearch', 'MySQL', 'RabbitMQ', 'ReactJS', 'Protocols: SNMP, Telnet, SSH'],
                'metrics' => [
                ...
                'midnight_fact' => 'Mô hình ML dự đoán chính xác sự cố sụt áp trạm truyền dẫn lúc 3:30 AM, giúp kỹ thuật viên xử lý trước khi gián đoạn dịch vụ.',
                'live_url' => null,
                'github_url' => null,
                'featured' => false,
                'order' => 4,
            ...
            [
                ...
                'tech_stack' => ['PHP / Laravel', 'MySQL', 'Redis', 'Python (Prediction Algorithms)', 'Docker', 'RESTful APIs'],
                'metrics' => [
                ...
                'midnight_fact' => 'Thuật toán dự báo đã giúp ngành y tế dự đoán chính xác ổ dịch sớm hơn 14 ngày so với phương pháp thống kê thủ công.',
                'live_url' => null,
                'github_url' => null,
                'featured' => false,
                'order' => 5,
            ...
            [
                ...
                'tech_stack' => ['PHP / Laravel', 'FFmpeg Transcoder', 'Redis Queue', 'RabbitMQ', 'MySQL', 'Nginx RTMP / HLS'],
                'metrics' => [
                ...
                'midnight_fact' => 'Duy trì luồng live stream trận chung kết thể thao với hơn 80,000 người xem đồng thời lúc nửa đêm mà không rớt một khung hình.',
                'live_url' => null,
                'github_url' => null,
                'featured' => false,
                'order' => 6,
