...
export const TIME_PHASES: Record<TimePhaseId, TimePhaseConfig> = {
  midnight: {
    id: 'midnight',
    name: 'Midnight Void',
    vietnameseName: 'Midnight Void',
    subtitle: 'Deep Flow & High-Velocity Autonomous Orchestration',
    timeRange: '00:00 — 05:59',
    icon: 'Moon',
    greeting: 'Welcome to Midnight Hub — Deep Engineering & Flow',
    statusBeacon: '🟢 AUTONOMOUS FLEET ONLINE · 24/7 ORCHESTRATION',
    caffeineLevel: 100,
    accentHex: '#00f5a0',
    ...
    tagline: 'Zero distractions, maximum architectural throughput',
    themeDescription: 'Peak hours for distributed systems design, multi-agent dispatching, and deterministic code generation.',
    badgeText: 'MIDNIGHT VOID'
  },
  dawn: {
    id: 'dawn',
    name: 'Golden Dawn',
    vietnameseName: 'Golden Dawn',
    subtitle: 'Morning Standup & Roadmap Alignment',
    timeRange: '06:00 — 11:59',
    icon: 'Sunrise',
    greeting: 'Good morning — Systems operational and ready for deployment',
    statusBeacon: '🟡 DAILY STANDUP & ROADMAP SYNCHRONIZATION',
    caffeineLevel: 45,
    accentHex: '#ffd166',
    ...
    tagline: 'Morning focus, strategic architecture planning',
    themeDescription: 'Clear headspace for code review approvals, release staging, and engineering roadmap alignment.',
    badgeText: 'GOLDEN DAWN'
  },
  afternoon: {
    id: 'afternoon',
    name: 'High-Noon Forge',
    vietnameseName: 'High-Noon Forge',
    subtitle: 'Peak Engineering & Production Shipping',
    timeRange: '12:00 — 17:59',
    icon: 'Sun',
    greeting: 'Productive afternoon — Shipping verified releases to production',
    statusBeacon: '🔵 PEAK PRODUCTION DISPATCH & VERIFICATION GATES',
    caffeineLevel: 65,
    accentHex: '#00d2ff',
    ...
    tagline: 'High-throughput verification, continuous delivery',
    themeDescription: 'Optimizing performance benchmarks, merging verified PRs, and deploying resilient cloud services.',
    badgeText: 'HIGH-NOON'
  },
  twilight: {
    id: 'twilight',
    name: 'Twilight Dusk',
    vietnameseName: 'Twilight Dusk',
    subtitle: 'Evening Transition & Night-Shift Preparation',
    timeRange: '18:00 — 23:59',
    icon: 'Sunset',
    greeting: 'Good evening — Transitioning to night-shift autonomy',
    statusBeacon: '🟣 EVENING SYSTEM AUDIT & REFACTOR PREVIEW',
    caffeineLevel: 80,
    accentHex: '#c084fc',
    ...
    tagline: 'Winding down daytime traffic, preparing night sprints',
    themeDescription: 'Comprehensive test runs, telemetry audits, and queuing autonomous tasks for overnight execution.',
