@php
    ...
    if ($isTheravada) {
        ...
        $defaultTitle = 'Midnight Hub — Supervised Vibe Coding & Autonomous AI Agent Studio';
        $defaultDesc = 'Nâng cấp Vibe Coding thành quy trình kỹ thuật phần mềm chuẩn chỉ. Điều phối Antigravity 2.0, Codex, Claude Code trong Git Worktree cô lập với Verification Evidence.';
        $defaultKeywords = 'Midnight Hub, Vibe Coding, AI Coding Agents, Antigravity 2.0, Claude Code, Verification Evidence, MCP Gateway, Git Worktree';
        $siteName = 'Midnight Hub';
        $favicon = '/brand/midnight-hub-mark.svg?v=20260829';
        $themeColor = '#04070d';
    } else {
        $defaultTitle = 'MacaTung (macatung.dev) — Senior Fullstack & AI Agent Architect';
        $defaultDesc = 'Portfolio và phòng thí nghiệm kiến trúc của Ma Cà Tưng: Multi-Agent AI tự trị, hệ thống phân tán chịu tải cao, hạ tầng viễn thông GIS/NMS và giải pháp phần mềm vị nhân sinh.';
        $defaultKeywords = 'Ma Cà Tưng, macatung.dev, Fullstack Developer, AI Agent Architect, Laravel, Vue.js, Multi-Agent Systems, Code at midnight';
        $siteName = 'Ma Cà Tưng • Code at midnight';
    ...
    <script type="application/ld+json">
    {
        ...
        "@graph": [
            ...
            },
            {
                ...
                "jobTitle": "Senior Fullstack & AI Agent Architect",
                "sameAs": [
            ...
            <nav aria-label="Sitemap navigation">
                <ul>
                    @if ($isTheravada)
                        ...
                        <li><a href="https://macatung.dev">Trang Chủ MacaTung</a></li>
                    @else
                        <li><a href="/projects">Dự Án Kiến Trúc & Kỹ Thuật</a></li>
                        <li><a href="/about">Giới Thiệu & Kỹ Năng</a></li>
                        <li><a href="/blog">Midnight Tech Chronicle (Blog)</a></li>
                        <li><a href="/desktop">Midnight Hub Desktop Companion</a></li>
                        <li><a href="/pricing">Bảng Giá & Gói Dịch Vụ</a></li>
                        <li><a href="/contact">Liên Hệ & Hợp Tác</a></li>
                        <li><a href="https://theravada.macatung.dev">Ma Tọa Thiền — Theravāda Dhamma</a></li>
                    @endif
                </ul>
            </nav>
        </main>
