...
class TaskHubMcpController extends \App\Http\Controllers\Controller
{
    ...
    private function tools(): array
    {
        return [
            ...
            ['name' => 'start_agent_run', 'description' => 'Create an auditable agent run for the selected task or an independent reviewer.', 'inputSchema' => ['type' => 'object', 'properties' => ['task_id' => ['type' => 'integer'], 'provider' => ['type' => 'string'], 'agent_session_id' => ['type' => 'string'], 'repository' => ['type' => 'string'], 'branch' => ['type' => 'string'], 'run_type' => ['type' => 'string', 'description' => 'implementation or review'], 'metadata' => ['type' => 'object'], 'context' => ['type' => 'object'], 'instruction' => ['type' => 'object']], 'required' => ['task_id', 'provider']]],
